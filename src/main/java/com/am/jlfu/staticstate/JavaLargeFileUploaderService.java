...
/**
 * Provides methods related to the management of information of the files for
 * services outside the scope of a request.<br>
 *
 * @author antoinem
...
public class JavaLargeFileUploaderService<T extends StaticStatePersistedOnFileSystemEntity> {
	...
	/**
	 * Retrieves the progress of the specified file for the specified
	 * client.<br>
	 *
	 *
	 * @param clientId
	 ...
	 *
	 * @param uuid
	 *            the uuid of the client, identifying the file
	 * @param entity
	 *            the entity to write into that file
	 */
	 ...
	 * Persists modifications onto filesystem only.
	 *
	 * @param staticStateFile
	 *            the file in which to write the entity
	 * @param entity
	 *            the entity to write into that file
	 */
	...
	private void write(T modelFromContext, File modelFile) {
		...
		try {
			...
			log.error("cannot write to model file for " + modelFromContext.getClass().getSimpleName() + ": "
					+ e.getMessage(), e);
		} finally {
	...
	/**
	 * Enables the processing of file uploads. Clients will automatically resume
	 * their upload.
	 *
	...
	/**
	 * Disables the processing of file uploads. Clients currently uploading
	 * Files will wait and automatically resume the uploads when
	 * {@link #enableFileUploader()} is called.
	 *
